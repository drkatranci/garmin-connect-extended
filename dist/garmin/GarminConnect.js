...
var GarminConnect = /** @class */ (function () {
    ...
    GarminConnect.prototype.getGolfScorecardHole = function (scorecardId, holeNumbers) {
        return __awaiter(this, void 0, void 0, function () {
            var params, url, golfHole, error_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        url = this.url.GOLF_SCORECARD_HOLE.replace('{{id}}', scorecardId);
                        return [4 /*yield*/, this.client.get(url, { params: params })];
                    case 1:
                        golfHole = _a.sent();
                        if (!golfHole) {
                            throw new Error('Invalid or empty golf hole data response.');
                        }
                        return [2 /*return*/, golfHole];
                    case 2:
                        error_9 = _a.sent();
                        throw new Error("Error in getGolfScorecardHole: ".concat(error_9.message));
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    GarminConnect.prototype.getHeartRate = function (date) {
        if (date === void 0) { date = new Date(); }
        return __awaiter(this, void 0, void 0, function () {
            var dateString, heartRate, error_10;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_10 = _a.sent();
                        throw new Error("Error in getHeartRate: ".concat(error_10.message));
                    case 3: return [2 /*return*/];
                }
            });
        });
